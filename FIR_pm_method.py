...
def REMEZ_FIR_MLLS(order, edge, fx, lgrid = 16, fs = 2.0, 
    ...
    a_coeffs, err, iext = REMEZ_EX_MLLS(nfcns, grid, des, wt, edge_idx, maxiter = maxit, bDebug=bDebug)
...
def REMEZ_EX_MLLS(nfcns, grid, des, wt, edge_idx, maxiter = 250, error_tol = 10e-4, bDebug = False):
