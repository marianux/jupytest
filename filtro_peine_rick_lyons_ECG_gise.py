...
for ii in regs_interes:
    ...
    plt.figure()
    plt.plot(zoom_region, ecg_one_lead[zoom_region], ':', label='ECG', alpha=0.5)

    # FIR con corrección de demora
    plt.plot(zoom_region, ECG_f_rl_fin[np.clip(zoom_region+demora_rl,0,cant_muestras-1)], label='final')
